...
<head>
  ...
  <title>Customer Dashboard - Three Brother Law</title>
...
<body class="bg-gray-100 font-sans">
  ...
  <div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-white shadow-lg flex flex-col justify-between">
      <div>
        ...
        <nav class="px-4 space-y-2">
          <a href="./customer-dashboard.php" class="flex items-center space-x-3 px-4 py-2 rounded-lg bg-gray-100 text-red-600 font-semibold">
    ...
    <main class="flex-1 p-12">
      ...
      <p class="text-xl text-gray-600 mb-10">Our beloved <span class="font-semibold">Customer</span></p>
      ...
      <div class="grid md:grid-cols-2 gap-10 max-w-3xl">
        ...
        <!-- Card 2 -->
        <a href="./consultation-status/consultation-status.php" 
          class="block bg-gray-200 rounded-lg overflow-hidden shadow hover:shadow-lg transition cursor-pointer">
          <div class="flex justify-center items-center h-48 text-7xl text-gray-600">
            <i class="fa-regular fa-inbox"></i>
          </div>
          <div class="bg-gray-700 text-white p-4 text-center">
            <h3 class="font-bold">Consultation Status</h3>
            <p>Status</p>
          </div>
        </a>
